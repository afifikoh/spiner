            ...
            <div class="col-md-4 col-sm-6 col-12"><br>
                <div class="info-box bg-light">
                    <div class="info-box-content">
                        ...
                        <a href="{{url ('/edit-profil-KepBidang/{id}')}}" class="nav-link" style="text-align: center"> 
            ...
            <div class="col-md-4 col-sm-6 col-12"><br>
                <div class="info-box bg-light">
                    <div class="info-box-content">
                        ...
                        <a href="{{url ('/edit-password-KepBidang/{id}')}}" class="nav-link" style="text-align: center"> 
                          <button type="button" class="btn btn-warning rounded-pill">Ubah sekarang</button>
                        </a>
                    </div>
                </div>
